...
(function() {
	tinymce.create('tinymce.plugins.XHTMLXtrasPlugin', {
		init : function(ed, url) {
			...
			ed.addCommand('mceLine', function() {
				ed.windowManager.open({
					file : url + '/line.htm',
					width : 350 + parseInt(ed.getLang('xhtmlxtras.line_delta_width', 0)),
					height : 250 + parseInt(ed.getLang('xhtmlxtras.line_delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url
				});
			...
			ed.addButton('line', {title : 'xhtmlxtras.line_desc', cmd : 'mceLine'});
			...
			ed.onNodeChange.add(function(ed, cm, n, co) {
				n = ed.dom.getParent(n, 'CITE,LINE,ACRONYM,ABBR,DEL,INS');

				cm.setDisabled('cite', co);
				cm.setDisabled('line', co);

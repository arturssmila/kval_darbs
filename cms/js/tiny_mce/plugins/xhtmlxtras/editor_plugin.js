(function(){tinymce.create("tinymce.plugins.XHTMLXtrasPlugin",{init:function(a,b)
{
	a.addCommand("mceCite",function()
		{
			a.windowManager.open(
				{
					file:b+"/cite.htm",
					width:350+parseInt(a.getLang("xhtmlxtras.cite_delta_width",0)),
					height:250+parseInt(a.getLang("xhtmlxtras.cite_delta_height",0)),inline:1
				},{plugin_url:b})
		});
	a.addCommand("mceLine",function()
		{
			a.windowManager.open(
				{
					file:b+"/line.htm",
					width:350+parseInt(a.getLang("xhtmlxtras.line_delta_width",0)),
					height:250+parseInt(a.getLang("xhtmlxtras.line_delta_height",0)),inline:1
				},{plugin_url:b})
		});
	...
	a.addButton("line",{title:"xhtmlxtras.line_desc",cmd:"mceLine"});
	...
	a.onNodeChange.add(function(d,c,f,e)
		{
			f=d.dom.getParent(f,"CITE,LINE,ACRONYM,ABBR,DEL,INS");
			c.setDisabled("cite",e);
			c.setDisabled("line",e);
			c.setDisabled("acronym",e);
			c.setDisabled("abbr",e);
			c.setDisabled("del",e);
			c.setDisabled("ins",e);
			c.setDisabled("attribs",f&&f.nodeName=="BODY");
			c.setActive("cite",0);
			c.setActive("line",0);
			c.setActive("acronym",0);
			c.setActive("abbr",0);
			c.setActive("del",0);
			c.setActive("ins",0);
			if(f){do{c.setDisabled(f.nodeName.toLowerCase(),0);c.setActive(f.nodeName.toLowerCase(),1)}while(f=f.parentNode)}
		});
